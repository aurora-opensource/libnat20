...
nat20cli promote -i 790fd72ee1352017d822773bc8f5c1ac6e4bf310dfac72fbff622368c01372bc78324f0c06cbc37964e32b18588560a386357e4517ffe93052c67fe6213c38bc
nat20cli eca-cert --key-type p256 --parent-key-type p256 --output eca.der --certificate-format x509 --challenge aabbcc
nat20cli eca-ee-cert --key-type p256 --parent-key-type p256 --output eca_ee.der --certificate-format x509 --challenge aabbcc --name "Test ECA EE Cert" --key-usage sign
nat20cli eca-ee-sign --key-type p256 --parent-key-type p256 --challenge aabbcc --name "Test ECA EE Cert" --key-usage sign --message "$(xxd -p message.txt)" --output eca_ee.sig
