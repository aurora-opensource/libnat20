...
std::vector<uint8_t> ENCODED_FALSE = {0x01, 0x01, 0x00};
std::vector<uint8_t> ENCODED_TRUE = {0x01, 0x01, 0xff};
...
std::vector<uint8_t> BYTES_ZERO = {};
std::vector<uint8_t> BYTES_ONE = {0x03};
std::vector<uint8_t> BYTES_TWO = {0x02, 0x01};
std::vector<uint8_t> BYTES_THREE = {0xff, 0x00, 0xa1};

std::vector<uint8_t> ENCODED_BYTES_ZERO = {0x04, 0x0};
std::vector<uint8_t> ENCODED_BYTES_ONE = {0x04, 0x01, 0x03};
std::vector<uint8_t> ENCODED_BYTES_TWO = {0x04, 0x02, 0x02, 0x01};
std::vector<uint8_t> ENCODED_BYTES_THREE = {0x04, 0x03, 0xff, 0x00, 0xa1};
...
std::vector<uint8_t> ENCODED_NULL = {0x05, 0x00};
...
std::vector<uint8_t> ENCODED_STRING_EMPTY = {0x13, 0x00};
std::vector<uint8_t> ENCODED_STRING_NOT_EMPTY = {0x13, 0x01, 0x7e};
std::vector<uint8_t> ENCODED_STRING_FULL_CHARSET = {
...
std::vector<uint8_t> ENCODED_TIME_ZERO = {0x18,
                                          0x0f,
                                          0x30,
                                          0x30,
                                          0x30,
                                          ...
                                          0x30,
                                          0x5a};
std::vector<uint8_t> ENCODED_TIME_NOT_ZERO = {0x18,
                                              0x0f,
                                              0x32,
                                              0x30,
                                              0x32,
