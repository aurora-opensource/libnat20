...
using AttestationCertificateVectorReader = TestVectorReader<Name, ParentKey, Key, CertificateFormat, WantCert>;

std::vector<AttestationCertificateVectorReader::tuple_type> attestationCertificateTestVectors =
    AttestationCertificateVectorReader::read_all_vectors_from_file("test_data/core/opendice_attestation_test_vectors.txt");
